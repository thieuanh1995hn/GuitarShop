							...
							<div
								...
								<div class="slider-text-inner">
									<div class="desc">
										...
										<p>${hotitem.info}</p>
										<p>
											<a href="/addcart?id=${hotitem.item_id}&quantity=1" 
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 text-center">
						<div class="feature-center animate-box"
							...
							<h3>Tiết kiệm</h3>
							<p>Khách hàng không phải chịu bật cứ chi phí nào phát sinh. Đồng thời các sản phẩm đều được bảo hành 2 năm</p>
							<p>
								<a href="#" class="btn btn-primary btn-outline">Learn More</a>
							</p>
						</div>
			...
			<div class="container">
				...
				<form id="fsearch" action="/searchresult#sl" method="get">
					<div class="input-group" style="width: 20.5%; margin: auto;">
						<input type="hidden" name="v" value="0" /> <input name="search"
						...
						<input type="hidden" name="p" value="1"> <input
							type="hidden" name="size" value="6"> <span
					...
					<select id="slview">
						<c:if test="${viewid == 0}">
							<option selected="selected"
								value="index?v=0&size=${size}&p=${pcursor}#fsearch">---Tùy chọn
								xem---</option>
							<option value="index?v=1&size=${size}&p=${pcursor}#fsearch">Giá
								từ thấp - cao</option>
							<option value="index?v=2&size=${size}&p=${pcursor}#fsearch">Giá
								từ cao - thấp</option>
						</c:if>
						<c:if test="${viewid == 1}">
							<option value="index?v=0&size=${size}&p=${pcursor}#fsearch">---Tùy
								chọn xem---</option>
							<option value="index?v=1&size=${size}&p=${pcursor}#fsearch"
								selected="selected">Giá từ thấp - cao</option>
							<option value="index?v=2&size=${size}&p=${pcursor}#fsearch">Giá
								từ cao - thấp</option>
						</c:if>
						<c:if test="${viewid == 2}">
							...
							<option value="index?v=1&size=${size}&p=${pcursor}#fsearch">Giá
								từ thấp - cao</option>
							<option value="index?v=2&size=${size}&p=${pcursor}#fsearch"
								selected="selected">Giá từ cao- thấp</option>
						</c:if>
					</select>
				</div>
				<div class="row" id="i">
						...
						<div class="display-tc">
							<div class="col-md-3 col-sm-6 animate-box">
								<div class="feature-center">
									<span class="icon"> <i class="icon-users"></i>
									</span> <span class="counter js-counter" data-from="0" data-to="${numberofusers}"
										data-speed="5000" data-refresh-interval="50">1</span> <span
										class="counter-label">Users</span>
							...
							<div class="col-md-3 col-sm-6 animate-box">
								<div class="feature-center">
									...
									</span> <span class="counter js-counter" data-from="0" data-to="${numberoforders}"
										data-speed="5000" data-refresh-interval="50">1</span> <span
										class="counter-label">Orders made</span>
								</div>
							</div>
							<div class="col-md-3 col-sm-6 animate-box">
								<div class="feature-center">
									<span class="icon"> <i class="icon-shop"></i>
									</span> <span class="counter js-counter" data-from="0" data-to="${numberofitems}"
										data-speed="5000" data-refresh-interval="50">1</span> <span
										class="counter-label">Items</span>
								</div>
							</div>
							<div class="col-md-3 col-sm-6 animate-box">
								<div class="feature-center">
									<span class="icon"> <i class="icon-clock"></i>
									</span> <span class="counter js-counter" data-from="0" data-to="${daysspent}"
										data-speed="5000" data-refresh-interval="50">1</span> <span
										class="counter-label">Days Spent</span>
